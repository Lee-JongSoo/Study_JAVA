...
import ch16_4.AboutDialog;
import ch16_4.AlertBox;
import ch16_4.EasyFile;
import ch16_4.LineEnumerator;
import ch16_4.TextFileDialog;
...
public class StandaloneGameOfLife extends GameOfLife {
    ...
    class GameOfLifeGridIO {
        ...
        public Shape makeShape( String name, String text ) {
            ...
            Enumeration enum1 = new LineEnumerator(text);
            while (enum1.hasMoreElements()) {
                String line = (String) enum1.nextElement();
